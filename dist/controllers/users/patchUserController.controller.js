...
const patchUserService_service_1 = require("../../services/users/patchUserService.service");
const patchUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userData = req.body;
    const userId = req.userId;
    const patchedUser = yield (0, patchUserService_service_1.patchUserService)(userId, userData);
