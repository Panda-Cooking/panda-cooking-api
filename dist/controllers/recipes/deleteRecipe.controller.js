...
const deleteRecipe_service_1 = __importDefault(require("../../services/recipes/deleteRecipe.service"));
const deleteRecipeController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield (0, deleteRecipe_service_1.default)(req.userId, req.params.id);
